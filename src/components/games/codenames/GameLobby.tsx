...
export default function GameLobby({ onCreateGame, onJoinGame, gameCode }: GameLobbyProps) {
  ...
  const shareUrl = gameCode ? `${window.location.origin}/games/codenames?code=${gameCode}` : "";
    ...
    return (
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="text-center mb-2">
          <h2 className="font-black text-3xl uppercase tracking-tight mb-2">Codenames Duet</h2>
          <p className="text-sm text-gray-500 max-w-xs">Cooperative word game for two. Give clues, find agents, avoid assassins.</p>
        </div>
