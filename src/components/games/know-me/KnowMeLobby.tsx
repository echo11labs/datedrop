...
interface KnowMeLobbyProps {
  onCreateGame: (playerName: string) => void;
  onJoinGame: (playerName: string, gameCode: string) => void;
  gameCode?: string;
}

export default function KnowMeLobby({ onCreateGame, onJoinGame, gameCode }: KnowMeLobbyProps) {
  ...
  const shareUrl = gameCode ? `${window.location.origin}/games/know-me?code=${gameCode}` : "";
    ...
    return (
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="text-center mb-2">
          <h2 className="font-black text-3xl uppercase tracking-tight mb-2">How Well Do You Know Me?</h2>
          <p className="text-sm text-gray-500 max-w-xs">Answer questions about each other and see how well you match!</p>
        </div>
